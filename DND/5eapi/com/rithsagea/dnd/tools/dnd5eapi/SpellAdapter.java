...
public class SpellAdapter implements JsonDeserializer<Dnd5eSpell> {

	@Override
	public Dnd5eSpell deserialize(JsonElement elem, Type type, JsonDeserializationContext context) throws JsonParseException {
		Dnd5eSpell spell = new Dnd5eSpell();
