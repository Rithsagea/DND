...
public class Datapack {
	...
	public Map<String, Dnd5eSubrace> DndSubrace = new HashMap<>();
	...
	public void registerClasses(Collection<Dnd5eClass> items) {
	...
	public void registerSubraces(Collection<Dnd5eSubrace> items) {
